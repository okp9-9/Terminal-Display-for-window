...
4. Choose your style, The result preview :
  <img align="center" width="100" height="100" src="./assets/styles.png">
...
7. Enter the Y skip pixel
   (This tell program how many pixel that ignore before get 1 pixel data, <br>This 2 factors are define your output resolution by (OGresolutionX / Xskip) x (OGresolutionY / Yskip))
